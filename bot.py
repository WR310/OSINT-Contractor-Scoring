...
BOT_TOKEN = "8632223694:AAHQbAnS8IvExEatLAI4tUFta3qrg7Z76W8"
ALLOWED_USERS = [1652878568] # ВСТАВЬ СЮДА СВОЙ TELEGRAM ID (числом, без кавычек)
...
async def process_inn(message: Message):
    ...
    try:
        ...
        await status_msg.edit_text("❌ Произошла внутренняя ошибка при формировании отчета.")
