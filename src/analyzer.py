...
class RiskAnalyzer:
    ...
    def analyze(self, company_data: Dict[str, Any]) -> str:
        ...
        2. Если открыты исполнительные производства (open_enforcement_proceedings > 0) или есть долги (total_debt_amount > 0) — это КРИТИЧЕСКИЙ КРАСНЫЙ ФЛАГ. Снижай оценку надежности.
        ...
        ШКАЛА РИСКА: 1 - идеальная компания (минимальный риск), 10 - мошенники или банкроты (огромный риск).

        📊 ОЦЕНКА РИСКА: [Укажи цифру от 1 до 10] / 10
